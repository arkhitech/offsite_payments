    ...
    module Paytoo
      ...
      class Helper < OffsitePayments::Helper
        include Common
          ...
          add_field('completed_url', 'http://localhost:3000/paytoo/success')
          add_field('cancelled_url', 'http://localhost:3000/paytoo/cancel')
          add_field('rejected_url', 'http://localhost:3000/paytoo/cancel')
