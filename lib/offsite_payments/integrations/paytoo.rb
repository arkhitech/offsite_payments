  ...
  module Integrations #:nodoc:
    module Paytoo
      ...
      class Helper < OffsitePayments::Helper
        include Common
            ...
            def initialize(order, account, options = {})
              ...
              add_field('completed_url', 'https://www.l81illustration.com/paytoo/success')
              add_field('cancelled_url', 'https://www.l81illustration.com/paytoo/cancel')
              add_field('rejected_url', 'https://www.l81illustration.com/paytoo/cancel')
      ...
      class Notification < OffsitePayments::Notification
        ...
        def complete?
          #     <input type="hidden" name="MerchantApiResponse[request_status]" value="completed">
          params[:MerchantApiResponse][:status] == "OK"
        end
